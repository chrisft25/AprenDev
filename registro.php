        ...
        <div class="wrap-login100 p-t-85 p-b-20">
          <form class="login100-form validate-form" method="post" action="">
            ...
            <div
              ...
              data-validate="Ingresa tu nombre completo"
            >
            ...
            <div
              class="wrap-input100 validate-input m-t-85 m-b-35"
              data-validate="Ingresa un nombre de usuario"
            >
            ...
            >
              <input class="input100" type="text" name="bioUsuario" />
              <span class="focus-input100" data-placeholder="Cuéntanos un poco sobre ti"></span>
            </div>
            ...
            >
              <input class="input100" type="text" name="expLaboral" />
              <span class="focus-input100" data-placeholder="Experiencia Laboral"></span>
            </div>
